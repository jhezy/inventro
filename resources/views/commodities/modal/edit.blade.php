					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nomor_seri" id="nomor_seri" placeholder="Masukan nomor seri..">
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="warna" id="warna" placeholder="Masukan warna barang..">
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-group">
								<label for="pengguna">Pengguna</label>
								<input type="text" class="form-control" name="pengguna" id="pengguna" placeholder="Masukan pengguna..">
							</div>
						</div>
					</div>
