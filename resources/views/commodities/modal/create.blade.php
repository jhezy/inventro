<div class="modal fade" id="commodity_create_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
			...
			<div class="modal-body">
				...
				<form action="{{ route('barang.store') }}" method="POST">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label for="commodity_category_id">Kategori Barang<span
										class="font-weight-bold text-danger">*</span></label>
								<select class="form-control @error('commodity_category_id', 'store') is-invalid @enderror"
									name="commodity_category_id" id="commodity_category_id" style="width: 100%;"
									placeholder="Pilih atau ketik lokasi barang..">
									<option value="" selected>Pilih..</option>
									@foreach ($commodity_categories as $commodity_category)
									<option value="{{ $commodity_category->id }}"
										@selected(old('commodity_category_id')==$commodity_category->id)>{{ $commodity_category->name }}
									</option>
									@endforeach
								</select>
								@error('commodity_category_id', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
								@enderror
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label for="name">Masa Barang<span class="font-weight-bold text-danger">*</span></label>
								<input type="text" class="form-control @error('masa', 'store') is-invalid @enderror" name="masa"
									id="masa" value="{{ old('masa') }}" placeholder="Masukan masa barang..">
								@error('masa', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label for="brand">Nomer Seri</label>
								<input type="number" class="form-control @error('nomor_seri', 'store') is-invalid @enderror" name="nomor_seri"
									id="nomor_seri" value="{{ old('nomor_seri') }}" placeholder="Masukan nomor seri..">
								@error('nomor_seri', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
								@enderror
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								<label for="ukuran">Ukuran<span class="font-weight-bold text-danger">*</span></label>
								<input type="text" class="form-control @error('ukuran', 'store') is-invalid @enderror" name="ukuran"
									id="ukuran" value="{{ old('ukuran') }}" placeholder="Masukan ukuran barang..">
								@error('ukuran', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
						...
						<div class="col-lg-4">
							<div class="form-group">
								<label for="warna">Warna<span class="font-weight-bold text-danger">*</span></label>
								<input type="text" class="form-control @error('warna', 'store') is-invalid @enderror" name="warna"
									id="warna" value="{{ old('warna') }}" placeholder="Masukan warna barang..">
								@error('warna', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
						...
						<div class="col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control @error('pengguna', 'store') is-invalid @enderror" name="pengguna"
									id="pengguna" value="{{ old('pengguna') }}" placeholder="Masukan pengguna..">
								@error('pengguna', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
								@enderror
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="form-group">
								<label for="residu">Residu Barang<span class="font-weight-bold text-danger">*</span></label>
								<input type="text" class="form-control @error('residu', 'store') is-invalid @enderror" name="residu"
									id="residu" value="{{ old('residu') }}" placeholder="Masukan residu barang..">
								@error('residu', 'store')
								<div class="d-block invalid-feedback">
									{{ $message }}
								</div>
						...
						<div class="col-lg-4 col-6">
							<div class="form-group">
								<label for="price">Total Harga<span class="font-weight-bold text-danger">*</span></label>
								<div class="input-group">
									<div class="input-group-prepend">
										<span class="input-group-text" id="basic-addon1">Rp.</span>
									</div>
