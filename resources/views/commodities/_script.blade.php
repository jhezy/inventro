		...
		$(".show-modal").click(function() {
			...
			$.ajax({
				...
				success: (res) => {
					...
					$("#show_commodity #nomor_seri").val(res.data.nomor_seri);
					$("#show_commodity #ukuran").val(res.data.ukuran);
					$("#show_commodity #warna").val(res.data.warna);
					$("#show_commodity #pengguna").val(res.data.pengguna);
				},
				error: (err) => {
		...
		$(".edit-modal").on("click", function() {
			...
			$.ajax({
				...
				success: (res) => {
					...
					$("#commodity_edit_modal form #nomor_seri").val(res.data.nomor_seri);
					$("#commodity_edit_modal form #ukuran").val(res.data.ukuran);
					$("#commodity_edit_modal form #warna").val(res.data.warna);
					$("#commodity_edit_modal form #pengguna").val(res.data.pengguna);
