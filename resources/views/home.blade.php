<x-layout>
	...
	<div class="row">
		<div class="col-md-4 col-lg-4">
			<div class="card">
				<x-bar-chart chartTitle="Barang Berdasarkan Kondisi" chartID="chartCommodityCondition"
		...
		<div class="col-md-4 col-lg-4">
			<div class="card">
				<x-bar-chart chartTitle="Jumlah Barang Berdasarkan Tahun Pembelian" chartID="chartCommodityCountEachYear"
